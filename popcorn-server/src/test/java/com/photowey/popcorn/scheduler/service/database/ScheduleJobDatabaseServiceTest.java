...
class ScheduleJobDatabaseServiceTest extends TestBase {
    ...
    void testSave() {
        ...
        this.scheduleJobDatabaseService.save(scheduleJob);
    }
    ...
    void testInsert() {
        ...
        this.scheduleJobDatabaseService.insert(scheduleJob);
    }
}
